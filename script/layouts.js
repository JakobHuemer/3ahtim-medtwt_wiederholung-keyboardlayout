...
/**
 *
 * @param layout {'QWERTY' | 'Dvorak' | 'Colemak' | 'Workman'}
 * @param keySet made with craftKeySet()
 * @returns {*}
 */
function craftLayoutWithKeys(layout, keySet) {
    ...
    if (Object.keys(LAYOUT_LIST).includes(layout)) {
        return LAYOUT_LIST[layout];
    } else {
        console.error('Layout', LAYOUT_LIST, 'is not there!');
    }
}
